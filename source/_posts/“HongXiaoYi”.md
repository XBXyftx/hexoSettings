...
cover: /imgs/ArticleTopImgs/hxyTopImg.webp
post_copyright:
...
![工作流](“HongXiaoYi”/100.webp)

大体就如下图所示：

![工作流](“HongXiaoYi”/1.webp)
...
![关键词提取大模型](“HongXiaoYi”/3.webp)

#### 输入

由于本模型的主要处理目标是从用户的提问中提取关键词，所以我们需要将用户的问题作为输入。

![输入](“HongXiaoYi”/2.webp)
...
![对召回数据进行格式处理](“HongXiaoYi”/10.webp)
...
![对召回数据进行格式处理](“HongXiaoYi”/11.webp)

官方给出的默认代码事例获取外部传入的参数靠的是点语法，但我在使用点语法时始终在报错，于是我决定去看看文档里是怎么说的。

![对召回数据进行格式处理](“HongXiaoYi”/12.webp)
...
![对召回数据进行格式处理](“HongXiaoYi”/13.webp)

的确干脆而且效果显著，整个工作流一下就畅通了。

![对召回数据进行格式处理](“HongXiaoYi”/14.webp)
...
![对召回数据进行格式处理](“HongXiaoYi”/15.webp)
...
![并发处理](“HongXiaoYi”/19.webp)

将原来的循环模块改为批处理模块来进行多线程并发处理。

![并发处理](“HongXiaoYi”/20.webp)
...
![最终答复大模型](“HongXiaoYi”/102.webp)

所以我们可以看到最终回复大模型是有三条线作为输入的。

![最终答复大模型](“HongXiaoYi”/21.webp)

最终的工作流如下图所示：

![最终答复大模型](“HongXiaoYi”/22.webp)
...
![浅色模式](“HongXiaoYi”/44.webp)
![深色模式](“HongXiaoYi”/45.webp)
...
![expandSafeArea](“HongXiaoYi”/48.webp)
...
![expandSafeArea](“HongXiaoYi”/50.webp)
...
![expandSafeArea](“HongXiaoYi”/54.webp)
...
![expandSafeArea](“HongXiaoYi”/58.webp)
...
![欢迎词](“HongXiaoYi”/68.webp)

enm……失败了，看看日志。

![日志](“HongXiaoYi”/69.webp)
...
![文档](“HongXiaoYi”/91.webp)

利用一个唯一标识来去存储对话历史记录，这很合理，那有没有可能是我的唯一标识变化了？

![日志](“HongXiaoYi”/93.webp)
...
![日志](“HongXiaoYi”/98.webp)

![日志](“HongXiaoYi”/107.webp)
