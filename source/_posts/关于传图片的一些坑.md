...
tags: 
  ...
  - 主题美化
  - 技术向
cover: /imgs/ArticleTopImgs/ImageTopImg.webp
...
![test](关于传图片的一些坑/test.webp)
`关于传图片的一些坑/test.png`这是我写的路径，在编辑器中预览是能正常显示的，效果如下图。
![复刻效果图](关于传图片的一些坑/FuKe1.webp)
在用localhost预览时是正常的
![localhost预览示意图](关于传图片的一些坑/FuKe2.webp)
...
![本地预览背景图片](关于传图片的一些坑/1.webp)

但当我hexo三连部署到GitHub上后用域名访问，背景图片却始终无法加载，如下图所示。

![本地预览背景图片](关于传图片的一些坑/2.webp)
...
![1737785543619](关于传图片的一些坑/1737785543619.webp)
在picgo中的效果如下
![3](关于传图片的一些坑/3.webp)
