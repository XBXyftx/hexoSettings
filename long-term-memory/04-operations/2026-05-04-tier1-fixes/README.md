...
| **Q13** | header-universe 性能优化(B4) | 🟡 中 | ✅ 已完成 | [Q13.md](Q13-header-universe-optimization.md) | `themes/butterfly/source/js/header-universe.js` |
...
- **2026-05-04**: commit `f84d526` — Q13 完成 — header-universe.js 性能优化:30fps 节流 + visibility 暂停 + 移动端降级 + resize 防抖 + PJAX 清理(B4)
