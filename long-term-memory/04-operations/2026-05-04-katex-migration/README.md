...
> **状态**: ✅ 已完成（公式保护持久化 + 表格公式显示修复 + MathJax 已物理删除）
> **执行轮次**: 第一轮 2026-05-04（基础设施迁移）+ 第二轮 2026-05-05（公式保护修复与持久化）+ 第三轮 2026-05-09（表格公式显示修复）+ 第四轮 2026-05-05（MathJax 物理删除，commit `1a26cc9`）
> **关联**: [../../07-known-issues/README.md](../../07-known-issues/README.md)(BUG-003) · KaTeX 当前方案位于 `source/js/katex/`
