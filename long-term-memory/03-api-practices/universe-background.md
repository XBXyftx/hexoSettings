...
- 2026-07-21 为配合首页卡片星空透窗，普通星与大星改为冷蓝白，普通星/大星峰值透明度约为 0.42–0.92，流星约为 0.58–0.92；绘制亮度倍率分别为 1.15、1.18、1.8，尾迹为 1.35。随后将普通星、大星、流星头部和尾迹宽度整体提高约 20%–25%；粒子数量、速度、帧率、尾迹段数和绘制次数未增加。
...
- 与背景层使用相同的冷蓝白颜色、透明度区间和亮度倍率，保证顶部封面与卡片透出的星光一致。
