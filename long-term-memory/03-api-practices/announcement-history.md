...
> **当前状态（2026-07-20）**：公告历史时间轴已在本地实现并通过构建；顶部新增第 20 期首页水纹与文章夜空背景视觉升级公告，继续复用现有 `/imgs/gifs/1.webp`，不替换公告 GIF。当前公告数据尚未推送；形成提交后可补记 `source_commit`。
...
当前档案已在顶部追加第 20 期、2026-07-20 的首页水纹与文章夜空背景视觉升级公告：
...
首批从本地 `_config.butterfly.yml` Git 历史恢复 16 期公告；历史时间轴上线公告为第 17 期，图库重构公告为第 18 期，Markdown 工作台公告为第 19 期，本次视觉升级公告后共 20 期：
