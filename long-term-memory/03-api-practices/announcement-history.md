...
> **当前状态（2026-07-16）**：公告历史时间轴已在本地实现并通过构建；顶部新增第 18 期“昨日重现”图库重构公告，当前公告数据仍未再次推送或部署。`source_commit` 可在未来形成提交后补记。
...
当前档案已在顶部追加第 18 期、2026-07-16 的“昨日重现”图库重构公告：
...
首批从本地 `_config.butterfly.yml` Git 历史恢复 16 期公告；历史时间轴上线公告为第 17 期，当前新增图库重构公告后共 18 期：
